	...
	<xsl:template match="gvl:Voucher">
		<html>
			...
			<body>
				...
				<p>Suspendisse potenti. Pellentesque commodo eros a enim. Vestibulum
				...
				<h2>Definitions</h2>
				<p>Praesent nec nisl a purus blandit viverra. Praesent ac massa at
				...
				<h2>Conditions</h2>
				<p>Nulla sit amet est. Praesent metus tellus, elementum eu, semper
					a,
